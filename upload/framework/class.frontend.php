...
class frontend extends wb {
    ...
    function get_website_settings()     { /* already done by index.php */ return true; }
    function page_select()              { /* already done by index.php */ return true; }
    function preprocess(&$content)      { return CAT_Helper_Page::preprocess($content); }
